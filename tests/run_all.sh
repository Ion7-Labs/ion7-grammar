...
# files starting with `1` need a generation model (ION7_MODEL). Discovery
# is alphabetic so the prefix dictates ordering.
#
# Usage:
#   bash tests/run_all.sh                                 # pure-Lua only
#   ION7_MODEL=/path/to/model.gguf bash tests/run_all.sh  # full suite
#
